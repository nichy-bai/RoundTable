<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/RoundTable_master.Master" AutoEventWireup="true" CodeBehind="MyDiscussion.aspx.cs" Inherits="RoundTable.WebForms.Discussion.MyDiscussion" %>
    ...
    <header
        ...
        <div class="relative px-0 flex flex-row flex-grow">
            <div class="flex flex-col justify-center">
                <span class="block text-4xl font-bold mb-2 font-title text-gray-700">My Discussion</span>
                <span class="block opacity-80">A list of all discussions you have initiated</span>
            </div>
        </div>
        <div class="flex flex-row items-center ml-4">
            <a href="../Discussion/CreateDiscussion.aspx" class="w-auto flex flex-row justify-center items-center p-3 bg-gray-700 rounded-lg text-gray-100 hover:shadow-md hover:bg-gray-600 ease-in-out duration-300">
                <svg
                    class="w-8 h-8"
                    fill="none"
                    stroke="currentColor"
                ...
                <span class="ml-2 hidden sm:inline font-title">Start Discussion</span>
            </a>
        </div>
    </header>

    <%--View my discussion post--%>
        ...
        <ItemTemplate>
            <div
                ...
                <asp:LinkButton ID="postBody_btn" runat="server" CssClass="flex flex-col cursor-pointer hover:shadow-md hover:text-gray-800 p-5 px-6 rounded-lg transition ease-in-out duration-500 border-r-4 border-b-4 border-transparent hover:border-gray-600" OnCommand="postBody_btn_Command" CommandArgument='<%#Eval("postID") %>' OnClientClick="window.document.forms[0].target='_blank';">
                    ...
                    <div class="flex flex-row flex-wrap justify-between items-start flex-wrap-reverse">
                        <%--Reaction--%>
                        ...
                        <%--Date--%>
                        <div class="flex flex-wrap text-sm opacity-80 no-underline mt-2">
