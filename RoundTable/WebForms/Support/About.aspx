    ...
    <div
        ...
        <div class="relative px-0 flex flex-row flex-grow">
            <div class="flex flex-col justify-center items-center w-full">
                <div class="text-3xl md:text-5xl font-bold mb-2 font-title tracking-wide flex flex-row justify-center items-center py-10 text-gray-800">
                    <svg
                        width="80"
                        height="80"
                        viewBox="0 0 500 500"
                ...
                <div class="text-xl font-medium text-center w-4/5 lg:w-1/2 opacity-80">RoundTable is the easiest way to start an asynchronous discussion for free and connect with the user through our global community!</div>
            </div>
        </div>
