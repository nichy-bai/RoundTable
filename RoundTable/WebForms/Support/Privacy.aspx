<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/RoundTable_master.Master" AutoEventWireup="true" CodeBehind="Privacy.aspx.cs" Inherits="RoundTable.WebForms.Support.Privacy" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div
        ...
        <div class="flex flex-col md:w-3/4 p-5 text-justify">
            <div class="text-4xl font-bold mb-2 font-title text-gray-700">Privacy Policy</div><br /><hr /><br />
            <div>
                <p>At RoundTable, accessible from roundtable.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by RoundTable and how we use it.</p><br />
                ...
                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in RoundTable. This policy is not applicable to any information collected offline or via channels other than this website. Our Privacy Policy was created with the help of the Privacy Policy Generator.</p><br />

                <h3 class="font-medium text-xl">Consent</h3><br />
                <p>By using our website, you hereby consent to our Privacy Policy and agree to its <a href="Terms.aspx" class="underline" target="_blank">terms</a>.</p><br />

                <h3 class="font-medium text-xl">Information we collect</h3><br />
                ...
                <h3 class="font-medium text-xl">How we use your information</h3><br />
                <p>We use the information we collect in various ways, including to:</p>
                <ul>
                    <li class="pl-10"><span class="select-none">•</span> Provide, operate, and maintain our website</li>
                    <li class="pl-10"><span class="select-none">•</span> Improve, personalize, and expand our website</li>
                    <li class="pl-10"><span class="select-none">•</span> Understand and analyze how you use our website</li>
                    <li class="pl-10"><span class="select-none">•</span> Develop new products, services, features, and functionality</li>
                    <li class="pl-10"><span class="select-none">•</span> Communicate with you, either directly or through one of our partners, including for customer service, to provide you with updates and other information relating to the website, and for marketing and promotional purposes</li>
                    <li class="pl-10"><span class="select-none">•</span> Send you emails</li>
                    <li class="pl-10"><span class="select-none">•</span> Find and prevent fraud</li>
                </ul><br />

                <h3 class="font-medium text-xl">Log Files</h3><br />
                ...
                <h3 class="font-medium text-xl">Cookies and Web Beacons</h3><br />
                ...
                <p>For more general information on cookies, please read <a href="https://www.privacypolicyonline.com/what-are-cookies/" class="underline" target="_blank">"What Are Cookies" from Cookie Consent</a>.</p><br />

                <h3 class="font-medium text-xl">Advertising Partners Privacy Policies</h3><br />
                <p>You may consult this list to find the Privacy Policy for each of the advertising partners of RoundTable.</p><br />
                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on RoundTable, which are sent directly to users' browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.</p><br />
                <p>Note that RoundTable has no access to or control over these cookies that are used by third-party advertisers.</p><br />

                <h3 class="font-medium text-xl">Third Party Privacy Policies</h3><br />
                <p>RoundTable's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options.</p><br />
                ...
                <h3 class="font-medium text-xl">CCPA Privacy Rights (Do Not Sell My Personal Information)</h3><br />
                <p>Under the CCPA, among other rights, California consumers have the right to:</p>
                <ul>
                    <li class="pl-10"><span class="select-none">•</span> Request that a business that collects a consumer's personal data disclose the categories and specific pieces of personal data that a business has collected about consumers.</li>
                    <li class="pl-10"><span class="select-none">•</span> Request that a business delete any personal data about the consumer that a business has collected.</li>
                    <li class="pl-10"><span class="select-none">•</span> Request that a business that sells a consumer's personal data, not sell the consumer's personal data.</li>
                </ul><br />
                ...
                <h3 class="font-medium text-xl">GDPR Data Protection Rights</h3><br />
                ...
                <h3 class="font-medium text-xl">Children's Information</h3><br />
