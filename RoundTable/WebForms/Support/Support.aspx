    ...
    <div
        ...
        <div class="relative px-0 flex flex-row flex-grow">
            <div class="flex flex-col justify-center items-center w-full">
                ...
                <div class="text-xl font-medium text-center my-5 w-4/5 lg:w-1/2 opacity-80 font-bold text-2xl">How can we help?</div>
        ...
        <div class="flex flex-row flex-wrap justify-center items-center my-24">
            <div class="my-10">
                <img src="../../Content/img/support_illustration_1.svg" alt="illustration_1" class="w-11/12 md:w-3/5 h-auto">
            </div>
            <div class="flex flex-col">
                <div>
                    <div>Getting Started</div>
                    <div>Using RoundTable</div>
                    <div>RoundTable Glossary</div>
                    <div>Create Discussion Post</div>
                    <div>Bug Reports and Feature Requests</div>
                </div>
                <div>
